...
const mapEncounterToInitiativeState = (encounter: Encounter): InitiativeEntityState[] => {
  ...
  return [
    ...entitiesWithPlayersFirst.map((entity, index) => mapEntityToInitiativeState(entity, index)),
  ];
}
    ...
    <>
      <Content title={`Decide initiative: ${name}`}>
        ...
        <Box sx={{
          ...
          <Button
            variant="contained"
            onClick={sortBasedOnInitiativeValuesCallback}
          >
            Update sort
          </Button>
                  ...
                  >
                    ...
                    >
                      <Box
                        sx={{minWidth: '15rem'}}
                      >
                        <strong>{entity.initiative + 1}.</strong>
                        {" "}
                        {entity.name}{" "}{entity.physicalObject.length === 0 ? '' : ` (${entity.physicalObject})`}
                      </Box>
                      {entity.isSurprised && (
                        <>
                          <Divider orientation="vertical" flexItem/>
                                  ...
                                  <FormControlLabel
                                    ...
                                    <Checkbox
                                      ...
                                      onChange={event => {
                                        ...
                                        dispatch(updateCondition({id: conditionsPopoverContext.id, condition: value, enabled}));
                                      }}
                                    />
                                  }
                    ...
                    {isCurrentTurn(entity, currentInitiative) && (
                      ...
                      >
                        ...
                        >
                          Next character
                          ({currentInitiative === (numberOfEntities - 1) ? 1 : (currentInitiative + 2)} / {numberOfEntities})
                        </Button>
                      </Stack>
                    )}
                  </Stack>
