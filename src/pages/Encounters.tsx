          ...
          <List>
            {sortedEncounters.map(encounter => (
              ...
              >
                ...
                >
                {`${encounter.name} (${encounter.entities.filter(entity => entity.isPlayerCharacter).length} players, ${encounter.entities.filter(entity => !entity.isPlayerCharacter).length} monsters)`}
                </span>
              </ListItem>
            ))}
          </List>
